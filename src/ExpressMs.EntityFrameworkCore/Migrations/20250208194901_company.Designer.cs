...
namespace ExpressMs.Migrations
{
    ...
    [Migration("20250208194901_company")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpressMs.Employees.EmployeesData", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<double>("DeflictPercent")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ExEmployeesData", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Employees.EmployeesPapersTypes", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExEmployeesPapersTypes", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Employees.PapersToUsers", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("EmployeesPapersTypeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EmployeesPapersTypeId");

                    b.HasIndex("UserId");

                    b.ToTable("ExPapersToUsers", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Employees.Penalities", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ExpressMs.PayrollEntities.PayrollPaySlip", b =>
                {
                    ...
                    b.ToTable("ExPayrollPaySlips", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.ApplicationAddressData", b =>
                {
                    ...
                    b.ToTable("ExApplicationAddressData", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.ApplicationDepartmentEvaluation", b =>
                {
                    ...
                    b.ToTable("ExApplicationDepartmentEvaluations", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.ApplicationPersonalEvaluation", b =>
                {
                    ...
                    b.ToTable("ExApplicationPersonalEvaluations", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Recruitment.ApplicationRefrence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExApplicationRefrences", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Recruitment.ApplicationTraining", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CourseCertificate")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ExApplicationTrainings", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Recruitment.ApplicationWorkExperiece", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("LastNetSalary")
                        .HasColumnType("float");
                    ...
                    b.Property<DateTime>("StartedForm")
                        .HasColumnType("datetime2");

                    b.Property<int>("Subord")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.CompanyRelations", b =>
                {
                    ...
                    b.ToTable("ExCompanyRelations", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Recruitment.ComputerLanguageSkills", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExComputerLanguageSkills", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.PersonalEmergencyPeople", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExPersonalEmergencyPeople", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.RecruitmentApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("AnnualRecord")
                        .HasColumnType("float");

                    b.Property<DateTime>("BirthDate")
                        .HasColumnType("datetime2");

                    b.Property<double>("CasualRecord")
                        .HasColumnType("float");
                    ...
                    b.Property<bool>("ExExpress_Employees")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("ExRecruitmentApplications", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Recruitment.RecruitmentApplicationEducation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ExpressMs.Requests.Request", b =>
                {
                    ...
                    b.Property<string>("ApprovalCycle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RequestConfigurations")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ExRequests", (string)null);
                });

            modelBuilder.Entity("ExpressMs.Requests.RequestCycle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExRequestCycles", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressMs.Vacations.VacationRecords", b =>
                {
                    ...
                    b.ToTable("ExVacationRecords", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressMs.Employees.PapersToUsers", b =>
                {
                    b.HasOne("ExpressMs.Employees.EmployeesPapersTypes", "EmployeesPapersTypes")
                        .WithMany()
                        .HasForeignKey("EmployeesPapersTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("EmployeesPapersTypes");
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.ApplicationAddressData", b =>
                {
                    b.HasOne("ExpressMs.Recruitment.RecruitmentApplication", "RecruitmentApplication")
                        .WithOne("ApplicationAddressData")
                        .HasForeignKey("ExpressMs.Recruitment.ApplicationAddressData", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.ApplicationWorkExperiece", b =>
                {
                    b.HasOne("ExpressMs.Recruitment.RecruitmentApplication", "RecruitmentApplication")
                        .WithMany("ApplicationWorkExperieces")
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.ComputerLanguageSkills", b =>
                {
                    b.HasOne("ExpressMs.Recruitment.RecruitmentApplication", "RecruitmentApplication")
                        .WithMany("ComputerLanguageSkills")
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.InsuranceData", b =>
                {
                    b.HasOne("ExpressMs.Recruitment.RecruitmentApplication", "RecruitmentApplication")
                        ...
                        .HasForeignKey("ExpressMs.Recruitment.InsuranceData", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.PersonalEmergencyPeople", b =>
                {
                    b.HasOne("ExpressMs.Recruitment.RecruitmentApplication", "RecruitmentApplication")
                        .WithMany("PersonalEmergencyPeople")
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.Position", b =>
                {
                    b.HasOne("ExpressMs.Recruitment.Department", "Department")
                        .WithMany("Positions")
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.RecruitmentApplication", b =>
                {
                    b.HasOne("ExpressMs.Recruitment.Position", "Positions")
                        .WithMany()
                        .HasForeignKey("PositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpressMs.Recruitment.RecruitmentApplication", b =>
                {
                    ...
                    b.Navigation("ApplicationTrainings");

                    b.Navigation("ApplicationWorkExperieces");
                    ...
                    b.Navigation("PersonalEmergencyPeople");
